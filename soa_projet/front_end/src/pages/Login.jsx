...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 👉 Stocker l'utilisateur (option recommandé)
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500">
      <div className="bg-white/90 backdrop-blur-md p-10 rounded-2xl shadow-2xl w-full max-w-md transform transition-all">
        ...
        {error && (
          <p className="text-red-500 bg-red-100 p-3 rounded-lg text-sm mb-6 text-center">
            {error}
          </p>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3.5 rounded-xl font-bold shadow-lg hover:shadow-xl hover:opacity-90 transition-all"
          >
            Connexion
          </button>
        </form>
